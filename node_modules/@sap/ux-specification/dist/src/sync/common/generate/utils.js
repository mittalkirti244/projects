...
function addKeyToDefinition(lineItemRecord, properties, schemaKey) {
    if (lineItemRecord['Value']) {
        properties[schemaKey][ux_specification_types_1.SchemaTag.key] = 'Value: ' + StableIdHelper_1.getStableIdPartFromValue(lineItemRecord['Value']);
    }
        ...
        properties[schemaKey][ux_specification_types_1.SchemaTag.key] = `Action: ${key}`;
        if (ns) {
        ...
        properties[schemaKey][ux_specification_types_1.SchemaTag.key] = `Target: ${key}`;
        ...
        properties[schemaKey][ux_specification_types_1.SchemaTag.key] = `Property: ${keyParts[keyParts.length - 1]}; SemanticObject: ${lineItemRecord['SemanticObject']}; Action: ${lineItemRecord['Action']}`;
    }
}
