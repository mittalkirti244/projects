...
function addActionRecordToSchema(data, actionsDefinition, lineItemPath, lineItemRecord, recordIndex) {
    ...
    if (lineItemRecord.Determining !== true) {
        ...
        actionDefinition[ux_specification_types_1.SchemaTag.key] = `Action: ${key}`;
        if (ns) {
 ...
 */
function addLineItemsTypeToSchema(data, columnDefinitionName = ux_specification_types_1.DefinitionName.TableColumn, customColumnDefinitionName = ux_specification_types_1.DefinitionName.CustomColumn, customActionDefinitionName = ux_specification_types_1.DefinitionName.CustomAction) {
 ...
 * @param sectionIdInManifest - identifier of the current object page section in manifest
 */
function addCustomActionDefinition(appSchema, v4Page, logger, customActionDefinitionName = ux_specification_types_1.DefinitionName.CustomAction, sectionId = '', sectionIdInManifest = '') {
    ...
    if (sectionIdInManifest) {
        if (customActionDefinitionName.indexOf(ux_specification_types_1.DefinitionName.FormCustomActionOP) !== -1) {
        ...
        if (customActionDefinitionName === ux_specification_types_1.DefinitionName.FormCustomActionOP) {
